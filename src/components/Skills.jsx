...
useEffect(() => {
  ...
  return (
    <section id="skills" ref={(ref) => setSectionRef(3, ref)} className="skills min-h-[auto] pb-28 bg-black text-white">
        <h2 className="text-[3rem] top-[150px] mb-8 text-center font-bold relative inline-block translate-y-[-50%] left-[42%]">My <span className="text-[#0bdfee]">Skills</span><span className='animated scroll' style={{ '--1': '1' }}></span></h2>
        <div className="skills-row ml-[10%] mr-[10%]">
            <div className="skills-column">
                <h3 className="title top-[90px]">Coding Skills<span className='animated scroll' style={{ '--1': '2' }}></span></h3>
                <div className="skills-box top-[90px]">
            ...
            <div className="skills-column">
                <h3 className="title top-[90px]">Professional Skills <span className='animated scroll' style={{ '--1': '5' }}></span></h3>
                <div className="skills-box top-[90px]">
                    <div className="skills-content">
                        <div className="progress">
